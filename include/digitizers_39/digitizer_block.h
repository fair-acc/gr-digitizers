...
namespace gr {
  namespace digitizers_39 {
     ...
     * \ingroup digitizers
     */
    enum DIGITIZERS_39_API acquisition_mode_t
    {
      RAPID_BLOCK,
      STREAMING
    };
     ...
     * \ingroup digitizers
     */
    enum DIGITIZERS_39_API coupling_t
    {
      DC_1M =  0,  /* DC, 1 MOhm */
      AC_1M =  1,  /* AC, 1 MOhm */
      DC_50R = 2,  /* DC, 50 Ohm */
     ...
     * \ingroup digitizers
     */
    enum DIGITIZERS_39_API trigger_direction_t
    {
     ...
     * \ingroup digitizers
     */
    enum DIGITIZERS_39_API downsampling_mode_t
    {
     ...
     * \ingroup digitizers
     */
    struct DIGITIZERS_39_API error_info_t
    {
      uint64_t timestamp;
      std::error_code code;
    };
     ...
     * \ingroup digitizers
     */
    class DIGITIZERS_39_API digitizer_block : virtual public gr::sync_block
    {
