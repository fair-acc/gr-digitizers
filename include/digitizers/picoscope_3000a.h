...
#ifndef INCLUDED_DIGITIZERS_PICOSCOPE_3000A_H
#define INCLUDED_DIGITIZERS_PICOSCOPE_3000A_H
  ...
  namespace digitizers {
    ...
    class DIGITIZERS_API picoscope_3000a : virtual public digitizer_block
    {
     public:
       ...
       *
       * To avoid accidental use of raw pointers, digitizers::picoscope_3000a's
       * constructor is in a private implementation
       * class. digitizers::picoscope_3000a::make is the public interface for
...
#endif /* INCLUDED_DIGITIZERS_PICOSCOPE_3000A_H */
