...
#ifndef INCLUDED_PULSED_POWER_DAQ_PICOSCOPE_BASE_H
#define INCLUDED_PULSED_POWER_DAQ_PICOSCOPE_BASE_H
  ...
  namespace pulsed_power_daq {
    ...
    class picoscope_base : public digitizer_source
    {
     ...
     public:
      ...
      picoscope_base(std::string serial_number, int max_ai_channels, int max_di_ports,
...
#endif /* INCLUDED_PULSED_POWER_DAQ_PICOSCOPE_BASE_H */