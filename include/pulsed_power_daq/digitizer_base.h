...
#ifndef INCLUDED_PULSED_POWER_DAQ_DIGITIZER_BASE_H
#define INCLUDED_PULSED_POWER_DAQ_DIGITIZER_BASE_H
...
namespace gr {
  namespace pulsed_power_daq {
     ...
     */
    enum PULSED_POWER_DAQ_API acquisition_mode_t
    {
      RAPID_BLOCK,
      STREAMING
    };
     ...
     * \ingroup pulsed_power_daq
     */
    enum PULSED_POWER_DAQ_API coupling_t
    {
      DC_1M =  0,  /* DC, 1 MOhm */
      AC_1M =  1,  /* AC, 1 MOhm */
      DC_50R = 2,  /* DC, 50 Ohm */
     ...
     * \ingroup pulsed_power_daq
     */
    struct PULSED_POWER_DAQ_API error_info_t
    {
      uint64_t timestamp;
      std::error_code code;
    };
     ...
     * \ingroup pulsed_power_daq
     */
    class PULSED_POWER_DAQ_API digitizer_base
    {
    ...
    public:
       ...
       *
       * This function will also call GR's set_output_multiple making sure that the number of
       * output items will be always a multiple of buffer size.
       *
       * Make sure to configure the max output buffer size with the value greater or equal to the
       * buffer size.
       *
...
#endif /* INCLUDED_PULSED_POWER_DAQ_DIGITIZER_BASE_H */