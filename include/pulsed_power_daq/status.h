...
#ifndef INCLUDED_PULSED_POWER_DAQ_STATUS_H
#define INCLUDED_PULSED_POWER_DAQ_STATUS_H
...
namespace gr {
  namespace pulsed_power_daq {
     ...
     */
    enum PULSED_POWER_DAQ_API channel_status_t
    {
    ...
    enum PULSED_POWER_DAQ_API algorithm_id_t
    {
      FIR_LP=0,
      FIR_BP,
      FIR_CUSTOM,
...
#endif /* INCLUDED_PULSED_POWER_DAQ_STATUS_H */