...
#ifndef INCLUDED_PULSED_POWER_DAQ_DIGITIZER_SOURCE_H
#define INCLUDED_PULSED_POWER_DAQ_DIGITIZER_SOURCE_H
...
{
  template <>
  struct is_error_code_enum<gr::pulsed_power_daq::digitizer_block_errc> : true_type {};
}

#endif /* INCLUDED_PULSED_POWER_DAQ_DIGITIZER_SOURCE_H */