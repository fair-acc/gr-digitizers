...
# Title: Simulation Source Streaming
# Generated: Fri Jun  8 17:26:01 2018
##################################################
...
class simulation_source_streaming(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Simulation Source Streaming")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Simulation Source Streaming")
        ...
        self.settings = Qt.QSettings("GNU Radio", "simulation_source_streaming")
...
def main(top_block_cls=simulation_source_streaming, options=None):
