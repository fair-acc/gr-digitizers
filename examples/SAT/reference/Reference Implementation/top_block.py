...
# Title: Top Block
# Generated: Wed Aug 16 11:21:10 2017
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.algorithm_ID = algorithm_ID = 5
        ...
        self.top_grid_layout.addWidget(self._freq_transition_win, 0,2,1,2)
        self._freq_min_range = Range(1, 10000, 1, 1000, 200)
        self._freq_min_win = RangeWidget(self._freq_min_range, self.set_freq_min, 'Min Frequency [Hz]', "counter_slider", float)
        self.top_grid_layout.addWidget(self._freq_min_win, 0,0,1,2)
        self._freq_max_range = Range(1, 10000, 1, 3000, 200)
        self._freq_max_win = RangeWidget(self._freq_max_range, self.set_freq_max, 'Max Frequency [Hz]', "counter_slider", float)
        self.top_grid_layout.addWidget(self._freq_max_win, 1,0,1,2)
        ...
        self.top_grid_layout.addWidget(self._out_delay_win, 1,3,1,1)
        ...
        self.top_grid_layout.addWidget(self._input_noise_est_win, 1,2,1,1)
        ...
        self.block_custom_filter_0 = block_custom_filter(
            ...
            iir_feedback_Taps=filter_taps_b,
            iir_forward_Taps=filter_taps_a,
            samp_rate=samp_rate,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.analog_noise_source_x_0, 0), (self.block_custom_filter_0, 0))
        self.connect((self.analog_noise_source_x_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.block_custom_filter_0, 0), (self.blocks_throttle_0, 0))
    ...
    def set_freq_transition(self, freq_transition):
        ...
        self.set_fir_LP( firdes.low_pass(1, self.samp_rate, self.freq_max, self.freq_transition, firdes.WIN_HAMMING, 6.76))
        self.block_custom_filter_0.set_freq_transition(self.freq_transition)
    ...
    def set_freq_max(self, freq_max):
        ...
        self.set_fir_LP( firdes.low_pass(1, self.samp_rate, self.freq_max, self.freq_transition, firdes.WIN_HAMMING, 6.76))
        self.block_custom_filter_0.set_freq_max(self.freq_max)
    ...
    def set_decimation(self, decimation):
        ...
        self.block_custom_filter_0.set_decimation(self.decimation)
    ...
    def set_freq_min(self, freq_min):
        ...
        self.block_custom_filter_0.set_freq_min(self.freq_min)
    ...
    def set_filter_taps_b(self, filter_taps_b):
        ...
        self.block_custom_filter_0.set_iir_feedback_Taps(self.filter_taps_b)
    ...
    def set_filter_taps_a(self, filter_taps_a):
        ...
        self.block_custom_filter_0.set_iir_forward_Taps(self.filter_taps_a)
