...
void power_calc_streaming(int runtime,
                        ...
                        int source_2_noice_percent=10)
{
    ...
    {
        source_1_noice_percent = 1;
    }
    else if (source_2_noice_percent == 0)
    {
        source_2_noice_percent = 1;
    }

    double source_1_noice_amp_percentage_calc = double((source_1_noice_percent / 100) * source_1_amp);
    double source_2_noice_amp_percentage_calc = double((source_2_noice_percent / 100) * source_2_amp);
