...
power_calc_cc_impl::~power_calc_cc_impl() {}
     ...
     * @param noutput_items The samples currently available for cumputation
     */
    void power_calc_cc_impl::calc_rms_u(float* output, const gr_complex* input, int noutput_items)
    {
     ...
     * @param noutput_items The samples currently available for cumputation
     */
    void power_calc_cc_impl::calc_rms_i(float* output, const gr_complex* input, int noutput_items)
    {
        for (int i = 0; i < noutput_items; i++) 
        {
          double mag_sqrd = input[i].real() * input[i].real();// + input[i].imag() * input[i].imag();
     ...
     * @param noutput_items The samples currently available for cumputation
     */
    void power_calc_cc_impl::calc_phi(float* phi_out, const gr_complex* u_in, const gr_complex* i_in, int noutput_items)
    {
        for (int i = 0; i < noutput_items; i++)
        { 
     ...
     * @param noutput_items The samples currently available for cumputation
     */
    void power_calc_cc_impl::calc_active_power(float* out, float* voltage, float* current, float* phi_out, int noutput_items)
    {
        for (int i = 0; i < noutput_items; i++) 
        {
     ...
     * @param noutput_items The samples currently available for cumputation
     */
    void power_calc_cc_impl::calc_reactive_power(float* out, float* voltage, float* current, float* phi_out, int noutput_items)
    {
        for (int i = 0; i < noutput_items; i++) 
        {
     ...
     * @param noutput_items The samples currently available for cumputation
     */
    void power_calc_cc_impl::calc_apparent_power(float* out, float* voltage, float* current, int noutput_items)
    {
        for (int i = 0; i < noutput_items; i++) 
        {
