...
namespace gr {
  namespace pulsed_power_daq {
    ...
    picoscope_4000a_source::sptr
    picoscope_4000a_source::make(std::string serial_number, bool auto_arm)
    {
      return gnuradio::make_block_sptr<picoscope_4000a_source_impl>(
        serial_number, auto_arm);
    }
    ...
    *********************************************************************/
    ...
    picoscope_4000a_source_impl::convert_frequency_to_ps4000a_time_units_and_interval(double desired_freq, double &actual_freq)
    {
     ...
     */
    picoscope_4000a_source_impl::picoscope_4000a_source_impl(std::string serial_number, bool auto_arm)
      : gr::sync_block("picoscope_4000a_source",
              gr::io_signature::make(0, 0, 0),
              gr::io_signature::make(16 /* min outputs */, 16 /*max outputs */, sizeof(float))),
     ...
     */
    picoscope_4000a_source_impl::~picoscope_4000a_source_impl()
    {
      driver_close();
    }
    ...
    std::string
    picoscope_4000a_source_impl::get_unit_info_topic(PICO_INFO info)
    {
      char line[40];
    ...
    std::string
    picoscope_4000a_source_impl::get_driver_version()
    {
    ...
    std::string
    picoscope_4000a_source_impl::get_hardware_version()
    {
      if (!d_initialized)
        return "NA";
    ...
    std::error_code
    picoscope_4000a_source_impl::driver_initialize()
    {
      PICO_STATUS status;
    ...
    std::error_code
    picoscope_4000a_source_impl::driver_configure()
    {
    ...
    void
    picoscope_4000a_source_impl::rapid_block_callback(int16_t handle, PICO_STATUS status)
    {
    ...
    std::error_code
    picoscope_4000a_source_impl::driver_disarm()
    {
    ...
    std::error_code
    picoscope_4000a_source_impl::driver_close()
    {
      if (d_handle == -1) {
        return std::error_code{};
      }
    ...
    std::error_code
    picoscope_4000a_source_impl::set_buffers(size_t samples, uint32_t block_number)
    {
      PICO_STATUS status;
    ...
    std::error_code
    picoscope_4000a_source_impl::driver_prefetch_block(size_t samples, size_t block_number)
    {
    ...
    std::error_code
    picoscope_4000a_source_impl::driver_get_rapid_block_data(size_t offset, size_t length,
    ...
    std::error_code
    picoscope_4000a_source_impl::driver_poll()
    {
