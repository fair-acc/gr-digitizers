...
#ifndef INCLUDED_PULSED_POWER_DAQ_MAINS_FREQUENCY_CALC_IMPL_H
#define INCLUDED_PULSED_POWER_DAQ_MAINS_FREQUENCY_CALC_IMPL_H
...
#endif /* INCLUDED_PULSED_POWER_DAQ_MAINS_FREQUENCY_CALC_IMPL_H */
