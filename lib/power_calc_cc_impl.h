...
#ifndef INCLUDED_PULSED_POWER_DAQ_POWER_CALC_CC_IMPL_H
#define INCLUDED_PULSED_POWER_DAQ_POWER_CALC_CC_IMPL_H
...
#endif /* INCLUDED_PULSED_POWER_DAQ_POWER_CALC_CC_IMPL_H */
