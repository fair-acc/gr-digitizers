...
static const std::map<std::string, std::pair<std::string, bool>, std::less<>> outputConfig{
...
static const std::map<std::string, std::string, std::less<>> demoSchedules = {{"Pattern 1", R"(
