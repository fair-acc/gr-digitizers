...
from gnuradio import gr, gr_unittest, blocks, digitizers

class test_simulation_source(gr_unittest.TestCase):
    def setUp(self):
    ...
    def test_instantiate(self):
        ...
        op = digitizers.simulation_source()
...
if __name__ == '__main__':
    gr_unittest.run(test_simulation_source)
