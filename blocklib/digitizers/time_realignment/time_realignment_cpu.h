...
public:
    ...
    bool add_timing_event(std::string event_id,
                          int64_t wr_trigger_stamp,
                          int64_t wr_trigger_stamp_utc) override;
...
private:
    ...
    // maximum time incoming triggers and samples will be buffered before forwarding them
    // without realligment of the trigger tags
