...
public:
    ...
    ~udp_sender() { d_socket.close(); }

    std::string host_and_port() { return d_host + ":" + d_port; }
...
class edge_trigger_cpu : public edge_trigger
{
public:
    explicit edge_trigger_cpu(const block_args& args);
