...
#include <gnuradio/picoscope6000/picoscope6000.h>
...
class picoscope_6000_impl : public digitizers::picoscope_impl {
private:
    int16_t d_handle;   // picoscope handle
    int16_t d_overflow; // status returned from getValues

public:
    picoscope_6000_impl(const digitizers::digitizer_args &args, std::string serial_number, logger_ptr logger);
...
class picoscope6000_cpu : public virtual picoscope6000 {
public:
    explicit picoscope6000_cpu(block_args args);
