...
const boost::ut::suite<"PicoscopeTimingTests"> PicoscopeTimingTests = [] {
    ...
    "triggeredTimingAcquisitionFast"_test = [&](const float samplingRate) { testTriggeredAcquisitionWithTiming<TPSImpl>(samplingRate, 7s, "D", 100us); } | std::array{125.0e6f};
};
