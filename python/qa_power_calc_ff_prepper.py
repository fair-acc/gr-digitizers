...
class qa_power_calc_ff_prepper(gr_unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Connections
        ##################################################
        self.tb.connect((self.pulsed_power_daq_power_calc_ff_prepper_0, 3), (self.blocks_null_sink_0, 0))
        self.tb.connect((self.pulsed_power_daq_power_calc_ff_prepper_0, 4), (self.blocks_null_sink_0, 1))
        self.tb.connect((self.pulsed_power_daq_power_calc_ff_prepper_0, 0), (self.pulsed_power_daq_power_calc_ff_0, 2))
        self.tb.connect((self.pulsed_power_daq_power_calc_ff_prepper_0, 2), (self.pulsed_power_daq_power_calc_ff_0, 0))
        self.tb.connect((self.pulsed_power_daq_power_calc_ff_prepper_0, 1), (self.pulsed_power_daq_power_calc_ff_0, 1))
        self.tb.connect((self.pulsed_power_daq_power_calc_ff_0, 1), (self.blocks_vector_sink_q, 0))
        self.tb.connect((self.pulsed_power_daq_power_calc_ff_0, 0), (self.blocks_vector_sink_p, 0))
        self.tb.connect((self.pulsed_power_daq_power_calc_ff_0, 3), (self.blocks_vector_sink_phi, 0))
        self.tb.connect((self.pulsed_power_daq_power_calc_ff_0, 2), (self.blocks_vector_sink_s, 0))
    ...
    def tearDown(self):
        self.tb = None
        self.pulsed_power_daq_power_calc_ff_prepper_0 = None
        self.pulsed_power_daq_power_calc_ff_0 = None
    ...
    def test_signal_source_offset_point5(self):
        ...
        self.tb.connect((self.analog_sig_source_voltage, 0), (self.pulsed_power_daq_power_calc_ff_prepper_0, 0))
        self.tb.connect((self.analog_sig_source_current, 0), (self.pulsed_power_daq_power_calc_ff_prepper_0, 1))
