...
/* BINDTOOL_HEADER_FILE_HASH(da016967d50aeb48291f85e1eb0804c2)                     */
/***********************************************************************************/
...
void bind_power_calc_cc(py::module& m)
{
    ...
    using power_calc_cc    = ::gr::pulsed_power_daq::power_calc_cc;


    py::class_<power_calc_cc, gr::sync_block, gr::block, gr::basic_block,
        ...
        .def("set_alpha",&power_calc_cc::set_alpha,       
            py::arg("alpha"),
